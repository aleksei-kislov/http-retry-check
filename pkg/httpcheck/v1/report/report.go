...
// ErrInvalidReport is returned when a report fails validation.
var ErrInvalidReport error = invalidReport

// ErrInvalidArtifact is returned when an artifact fails validation.
var ErrInvalidArtifact error = invalidArtifact
...
func observationFromResult(observation httpcheck.Observation) Observation {
	return Observation{
		...
		AttemptLimit: observation.AttemptLimit, Protocol: observation.Protocol,
