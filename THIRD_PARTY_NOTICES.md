...
The standalone examples fetch pinned third-party packages from their own Go
module or NuGet lock file; the root Go module and production C# library remain
dependency-free.
...
- C# package builds restore `Microsoft.NET.ILLink.Tasks` for trimming and AOT
  analysis. It is build tooling, not a dependency of the published library.
