...
public static partial class ScenarioReports
{
    ...
    /// <summary>Decodes and validates a canonical v2 report within the size limit.</summary>
...
internal static class ReportJsonCodec
{
    ...
    private static void WriteObservation(Utf8JsonWriter writer, ReportObservation observation)
    {
        ...
        writer.WriteNumber("attempt_limit", observation.AttemptLimit);
        writer.WriteString("protocol", observation.Protocol);
    ...
    private static ReportObservation ReadObservation(ref Utf8JsonReader reader)
    {
        ...
        ReadProperty(ref reader, "attempt_limit");
        var attemptLimit = ReadUInt32(ref reader);
        ReadProperty(ref reader, "protocol");
