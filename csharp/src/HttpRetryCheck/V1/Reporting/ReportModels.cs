...
public sealed class ReportSummary
{
    ...
    /// <summary>Gets the total number of scenarios.</summary>
    public uint Scenarios { get; }

    /// <summary>Gets the number of scenarios that passed.</summary>
    public uint Passed { get; }

    /// <summary>Gets the number of scenarios assessed as unsafe.</summary>
    public uint Failed { get; }

    /// <summary>Gets the number of inconclusive scenarios.</summary>
...
public sealed class ReportFinding
{
    ...
    /// <summary>Gets the fixed human-readable finding text.</summary>
...
public sealed class ReportScenario
{
    ...
    /// <summary>Gets the fixed human-readable scenario text.</summary>
    public string ScenarioText { get; }

    /// <summary>Gets the scenario assessment.</summary>
    public Assessment Assessment { get; }

    /// <summary>Gets the fixed human-readable assessment text.</summary>
    public string AssessmentText { get; }

    /// <summary>Gets the facts recorded for the scenario.</summary>
...
public sealed class Report
{
    ...
    /// <summary>Gets the report schema identity.</summary>
    public string SchemaVersion { get; }

    /// <summary>Gets the scenario-suite identity.</summary>
    public string SuiteIdentity { get; }

    /// <summary>Gets the identity of the fixed explanatory text.</summary>
    public string ExplanationIdentity { get; }

    /// <summary>Gets the statement that bounds what the report establishes.</summary>
    public string ClaimCeiling { get; }

    /// <summary>Gets the aggregate suite assessment.</summary>
    public Assessment Assessment { get; }

    /// <summary>Gets the fixed human-readable aggregate assessment.</summary>
    public string AssessmentText { get; }

    /// <summary>Gets the CI-oriented outcome.</summary>
    public Outcome Outcome { get; }

    /// <summary>Gets the report outcome counts.</summary>
    public ReportSummary Summary { get; }

    /// <summary>Gets the six ordered scenario rows.</summary>
