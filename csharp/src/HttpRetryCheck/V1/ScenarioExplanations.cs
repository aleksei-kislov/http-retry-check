...
/// <summary>Returns the stable human-readable text for suite identifiers.</summary>
public static class ScenarioExplanations
{
    /// <summary>Returns the description for a scenario identifier.</summary>
    /// <param name="scenario">The scenario identifier.</param>
    /// <returns>The scenario description, or an unknown-scenario message.</returns>
    ...
    /// <summary>Returns the description for an assessment.</summary>
    /// <param name="assessment">The assessment.</param>
    /// <returns>The assessment description, or an unknown-assessment message.</returns>
    ...
    /// <summary>Returns the fixed description for a finding code.</summary>
    /// <param name="finding">The finding code.</param>
    /// <returns>The finding description, or an unknown-finding message.</returns>
    public static string FindingText(FindingCode finding)
    {
        return finding switch
        {
            ...
            FindingCode.AttemptLimitExceeded =>
                "The client made more than the allowed number of attempts.",
