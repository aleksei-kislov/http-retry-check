...
internal static class RuntimeConstants
{
    ...
    internal const uint MinimumAttemptLimit = 1;
    internal const uint DefaultAttemptLimit = 2;
    internal const uint MaximumAttemptLimit = 3;
    internal const int MaximumObservedAttempts = 4;
    ...
    internal const string Http11Protocol = "HTTP/1.1";
    ...
    internal static TimeSpan PostInvocationQuietPeriod => TimeSpan.FromMilliseconds(300);
