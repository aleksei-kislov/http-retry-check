...
{
    internal static Task<CaptureResult> ReadAsync(
        Socket socket,
        IPEndPoint expectedEndpoint,
        CancellationToken cancellationToken)
    {
        return ReadAsync(socket, expectedEndpoint, requestHeadObserved: null, cancellationToken);
    }

    internal static async Task<CaptureResult> ReadAsync(
        Socket socket,
        IPEndPoint expectedEndpoint,
        Action? requestHeadObserved,
        CancellationToken cancellationToken)
    {
