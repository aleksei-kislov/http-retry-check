...
internal sealed class HTTP_RETRY_CHECK_CORPUS_MARKER_7Q4VX9SenderHandler : HttpMessageHandler
{
        ...
        CancellationToken cancellationToken)
    {
        switch (vector)
        {
            ...
            case "sanitation_replay_behavior":
                request.Content = new CorpusMarkerThrowingContent();
    ...
    private sealed class CorpusMarkerThrowingContent : HttpContent
    {
        protected override Task SerializeToStreamAsync(Stream stream, TransportContext? context)
        {
            return Task.FromException(new HTTP_RETRY_CHECK_CORPUS_MARKER_7Q4VX9CallbackException());
        }
